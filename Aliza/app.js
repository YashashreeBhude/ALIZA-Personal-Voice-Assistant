...
const SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;//turn spoken text into speech
...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')||message.includes('hii')) {
        ...
        const finalText = "Don't get Formal in front of me because You know i made only for you";
        speech.text = finalText;
    }
    ...
    else if(message.includes('play god song')) {
        window.open("https://www.youtube.com/watch?v=xg8jjcBQ0ok");
        const finalText = "Playing song";
        speech.text = finalText;
    }

    else if(message.includes('play sad song')) {
        window.open("https://www.youtube.com/watch?v=nUPbntq3UnI");
        const finalText = "Playing song";
        speech.text = finalText;
    }

    else if(message.includes('play happy song')) {
        window.open("https://www.youtube.com/watch?v=5CfDm6Z-ado");
        const finalText = "Playing song";
        speech.text = finalText;
    }

    else if(message.includes('play silent song')) {
        window.open("https://www.youtube.com/watch?v=T0PIrzGW0fc");
        const finalText = "Playing song";
        speech.text = finalText;
    }

    else if(message.includes('play marathi song')) {
        window.open("https://www.youtube.com/watch?v=bJrX-SDn_xc&t=81s");
        const finalText = "Playing song";
        speech.text = finalText;
    }

    else if(message.includes('play old song')) {
        window.open("https://www.youtube.com/watch?v=5HvPhqmzGQ8&t=25s");
        const finalText = "Playing song";
        speech.text = finalText;
    }
